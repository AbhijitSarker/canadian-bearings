...
const CategoryCard = ({ icon, name }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-white rounded-lg p-4 cursor-pointer border border-gray-200 hover:border-green-500 hover:shadow-md transition-all duration-200 w-full max-w-[170px] h-auto">
      ...
      <span className="text-base font-light text-gray-800 text-center leading-4 break-words">{name}</span>
    </div>
  );
};
